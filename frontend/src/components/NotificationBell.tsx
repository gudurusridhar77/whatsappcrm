...
const s: Record<string, React.CSSProperties> = {
  ...
  badge: {
    position: 'absolute', top: '-2px', right: '0', backgroundColor: '#ef4444',
    color: '#fff', fontSize: '10px', fontWeight: 700, borderRadius: '10px',
  ...
  dropdownTitle: { fontWeight: 600, fontSize: '15px', color: '#333' },
  dropdownActions: { display: 'flex', gap: '6px' },
  filterBtn: {
    padding: '3px 8px', fontSize: '11px', border: '1px solid #ddd', borderRadius: '4px',
    backgroundColor: '#fff', cursor: 'pointer', color: '#666',
  },
  filterActive: { backgroundColor: '#1b72e8', color: '#fff', borderColor: '#1b72e8' },
  markAllBtn: {
    padding: '3px 8px', fontSize: '11px', border: 'none', borderRadius: '4px',
    backgroundColor: 'transparent', cursor: 'pointer', color: '#1b72e8', fontWeight: 500,
  },
  notifList: { overflowY: 'auto', flex: 1 },
  empty: { textAlign: 'center', color: '#999', padding: '40px 16px', fontSize: '13px' },
  notifItem: {
  ...
  notifTitle: { fontSize: '13px', fontWeight: 600, color: '#333', marginBottom: '2px' },
  notifMessage: {
    fontSize: '12px', color: '#666', overflow: 'hidden', textOverflow: 'ellipsis',
    whiteSpace: 'nowrap' as const,
  },
  notifTime: { fontSize: '11px', color: '#999', marginTop: '3px' },
  unreadDot: {
