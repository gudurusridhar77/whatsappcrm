...
const styles: Record<string, React.CSSProperties> = {
  panel: {
    width: '280px', borderLeft: '1px solid #e5e7eb', display: 'flex',
  ...
  contactEmail: { fontSize: '12px', color: '#999' },
  tabs: { display: 'flex', borderBottom: '1px solid #e5e7eb' },
  tab: {
    flex: 1, padding: '8px', border: 'none', backgroundColor: 'transparent',
    cursor: 'pointer', fontSize: '12px', fontWeight: 500, color: '#666',
    borderBottom: '2px solid transparent',
  },
  tabActive: { color: '#1b72e8', borderBottom: '2px solid #1b72e8' },
  tabContent: { flex: 1, overflowY: 'auto' as const, padding: '12px' },
  error: { backgroundColor: '#fef2f2', color: '#dc2626', padding: '6px 12px', fontSize: '12px', margin: '0 12px' },
  ...
  noteBtn: {
    marginTop: '4px', padding: '4px 12px', backgroundColor: '#1b72e8', color: '#fff',
    border: 'none', borderRadius: '4px', cursor: 'pointer', fontSize: '12px',
  },
  notesList: { display: 'flex', flexDirection: 'column' as const, gap: '8px' },
  empty: { textAlign: 'center' as const, color: '#999', fontSize: '13px', padding: '20px 0' },
  noteCard: {
    backgroundColor: '#fff', padding: '10px', borderRadius: '6px',
    border: '1px solid #e5e7eb',
  },
  noteContent: { fontSize: '13px', color: '#333', lineHeight: '1.4', marginBottom: '6px' },
  noteMeta: {
    display: 'flex', justifyContent: 'space-between', alignItems: 'center',
    fontSize: '11px', color: '#999',
  },
  tinyBtn: {
    background: 'none', border: 'none', color: '#1b72e8', cursor: 'pointer',
  ...
  miniBtn: {
    padding: '2px 8px', backgroundColor: '#1b72e8', color: '#fff',
    border: 'none', borderRadius: '3px', cursor: 'pointer', fontSize: '11px',
  },
  miniBtnGray: {
    padding: '2px 8px', backgroundColor: '#f3f4f6', color: '#333',
    border: '1px solid #ddd', borderRadius: '3px', cursor: 'pointer', fontSize: '11px',
  },
  timeline: { display: 'flex', flexDirection: 'column' as const, gap: '0' },
  timelineItem: {
    display: 'flex', gap: '10px', paddingBottom: '14px',
    borderLeft: '2px solid #e5e7eb', marginLeft: '5px', paddingLeft: '14px',
    position: 'relative' as const,
  },
  timelineDot: {
    position: 'absolute' as const, left: '-5px', top: '2px',
    width: '8px', height: '8px', borderRadius: '50%', backgroundColor: '#1b72e8',
  },
  timelineContent: {},
  activityTitle: { fontSize: '13px', fontWeight: 500, color: '#333' },
  activityMeta: { fontSize: '11px', color: '#999', marginTop: '2px' },
  activityDetail: {
    fontSize: '12px', color: '#666', marginTop: '4px', fontStyle: 'italic' as const,
  },
};
