...
const styles: Record<string, React.CSSProperties> = {
  ...
  codePrefix: {
    padding: '8px 10px', backgroundColor: '#f3f4f6', color: '#666',
  ...
  previewLabel: { fontSize: '11px', color: '#999', marginBottom: '4px', textTransform: 'uppercase' as const },
  previewContent: { fontSize: '14px', color: '#333', lineHeight: '1.5' },
  ...
  empty: {
    ...
    backgroundColor: '#fff', borderRadius: '8px', boxShadow: '0 1px 3px rgba(0,0,0,0.08)',
  },
